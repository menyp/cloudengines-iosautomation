...
public class sanityNativeIosAppium {
	...
	public void uploadExistingPotos() throws Exception, Throwable {
		...
		genMeth.takeScreenShotNative(driver, genMeth, "positive_uploaded_IMG_0004");
		...
		genMeth.isElementVisibleNative(driver, By.name(iosData.UploadExistingVideo_Name));
		genMeth.takeScreenShotNative(driver, genMeth, "positive_IMG_01188.MOV");
	...
	public void createNewUser() throws Exception, Throwable {
		...
		genMeth.takeScreenShotNative(driver, genMeth, "positive_bad_email_format");
	...
	public void settingsBackupEnableDisableDuringUpload() throws Exception,Throwable {
		...
		genMeth.isElementVisibleNative(driver, By.name(iosData.Backup_Name));
		genMeth.isElementVisibleNative(driver, By.name(iosData.Disabled_Name));
		genMeth.takeScreenShotNative(driver, genMeth, "Positive_TimelineThumbnail_settingsBackupEnableDisableDuringUpload");
		genMeth.clickName(driver, genMeth, iosData.BTNenable_Name);
		...
		genMeth.isElementVisibleNative(driver, By.name(iosData.Disabled_Name));
		genMeth.isElementVisibleNative(driver, By.name(iosData.BTNenable_Name));
		genMeth.takeScreenShotNative(driver, genMeth, "Positive_VideoThumbnail_settingsBackupEnableDisableDuringUpload");
		genMeth.clickName(driver, genMeth, iosData.BTNenable_Name);
		genMeth.isElementVisibleNative(driver, By.name(iosData.BTNwifiAndCellular_Name));
		genMeth.clickName(driver, genMeth, iosData.BTNenable_Name);
		...
		genMeth.isElementVisibleNative(driver, By.name(iosData.Disabled_Name));
		genMeth.isElementVisibleNative(driver, By.name(iosData.BTNenable_Name));
		genMeth.takeScreenShotNative(driver, genMeth, "Positive_AlbumsThumbnail_settingsBackupEnableDisableDuringUpload");
		genMeth.clickName(driver, genMeth, iosData.BTNenable_Name);
		genMeth.isElementVisibleNative(driver, By.name(iosData.BTNwifiAndCellular_Name));
		genMeth.clickName(driver, genMeth, iosData.BTNenable_Name);
		...
		genMeth.isElementInvisibleTextNative(driver, By.name(iosData.ImageNotAvailable_Name),iosData.ImageNotAvailable_Name);
		Thread.sleep(2000);
		genMeth.takeScreenShotNative(driver, genMeth, "Positive_ImagePreview_settingsBackupEnableDisableDuringUpload");
	...
	public void backupInBackground() throws Exception, Throwable {
		...
		Thread.sleep(2000);
		genMeth.isElementInvisibleTextNative(driver, By.name(iosData.ImageNotAvailable_Name),iosData.ImageNotAvailable_Name);
		genMeth.takeScreenShotNative(driver, genMeth, "positive_backupInBackground");
	...
	public void foregroundBackgroundSwith() throws Exception, Throwable {
		...
		public void Favorites() throws InterruptedException, IOException, ParserConfigurationException, SAXException{
			...
			genMeth.takeScreenShotNative(driver, genMeth, iosData.FavoritesTitle_Name);
			genMeth.clickName(driver, genMeth, iosData.BTNleft_Name);
			genMeth.clickName(driver, genMeth, iosData.BTNfileExplorer_Name);
	...
	public void addRemoveTeamFolders() throws Exception, Throwable {
		...
		genMeth.takeScreenShotNative(driver, genMeth, "positive_teamFolderSharedUsersNumber");
		genMeth.clickName(driver, genMeth, iosData.BTNdone_Name);
		genMeth.clickName(driver, genMeth, iosData.BTNleft_Name);
		...
		genMeth.clickName(driver, genMeth, iosData.BTNremoveAllUsers_Name);
		Thread.sleep(2000);
		genMeth.takeScreenShotNative(driver, genMeth, "positive_teamFolderSharedUsersRemoveNumber");
		genMeth.clickName(driver, genMeth, iosData.BTNleft_Name);
		genMeth.clickName(driver, genMeth, iosData.Settings_Name);
		genMeth.signOutFromStartupIphone5(driver, iosData);
